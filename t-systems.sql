...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 21. Feb 2023 um 13:15
...
INSERT INTO `rolle` (`ID`, `Tätigkeit`) VALUES
(1, 'TA'),
(2, 'FK'),
(3, 'PA'),
(4, 'Mitarbeiter');
...
--
-- Tabellenstruktur für Tabelle `to do`
--
...
CREATE TABLE `to do` (
  ...
  `Ergebniss` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Daten für Tabelle `to do`
--

INSERT INTO `to do` (`T_ID`, `ID`, `Aufgabenstellung`, `Start`, `Ende`, `Fertig`, `Ergebniss`) VALUES
...
INSERT INTO `user` (`ID`, `Vorname`, `Nachname`, `Telefonnummer`, `Email`, `Plz`, `Ort Name`, `Strasse`, `Hausnummer`, `Passwort`) VALUES
...
--
-- AUTO_INCREMENT für Tabelle `to do`
--
ALTER TABLE `to do`
...
--
-- Constraints der Tabelle `to do`
--
ALTER TABLE `to do`
  ADD CONSTRAINT `to do_ibfk_1` FOREIGN KEY (`ID`) REFERENCES `user` (`ID`);
COMMIT;
